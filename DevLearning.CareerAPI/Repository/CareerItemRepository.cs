...
namespace DevLearning.CareerAPI.Repository
{
    public class CareerItemRepository : ICareerItemRepository
    {
        ...
        public async Task<bool> GetCareerItemByIdAsync(Guid CareerId, string CourseId)
        {
            try
            {
                var sql = @"SELECT *
                ...
                var careerItem = await connection.QueryFirstOrDefaultAsync<CareerItemResponseDTO>
                    (sql, new { CareerId = CareerId, CourseId = CourseId });
        ...
        public async Task<bool> UpdateCareerItemAsync(Guid CareerId, string CourseId, List<string> updates, DynamicParameters parameters)
        {
            try
            {
        ...
        public async Task<bool> DeleteCareerItemAsync(Guid CareerId, string CourseId)
        {
            try
            {
